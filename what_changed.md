...
- `OneTimeAuthorizationStore` had an analogous distinct-nonce capacity race. Final runtime source commit `406c2cfb48c45e04cc34662776e67a68f167745d` adds atomic prune/duplicate/cap/add admission under an explicit gate.
...
- Candidate commit `6b1544b3a91ecfef2937a909f58a7e9faee31cff` expands both `push` and `pull_request` path filters to production source, portable tests, benchmarks, `SwiftDrop.slnx`, `Directory.Build.props`, `global.json`, `NuGet.config`, and the existing verification/audit/evidence helper paths.
...
- Exact runtime source-changing head: `406c2cfb48c45e04cc34662776e67a68f167745d`.
- Hosted platform run **31877893372** completed successfully for Android, focused Windows, Mac Catalyst, iOS Simulator Share Extension, and iOS Simulator containing app, including target dependency/vulnerability audit generation and uploads.
- Platform evidence digests recorded by GitHub Actions:
  - `android-dependency-audit`: `sha256:64d42198e8ba039b3e27a0f9dbe29456f67b6194102ce7a4e90e94ce5e50d072`
  - `windows-dependency-audit`: `sha256:b91275a0a3af00ca913f0fbbe9811b156b7d366fbcaa8ea0e032814c75bccf79`
  - `apple-dependency-audit`: `sha256:9ff19f16d821d92dbb131320587887882505565e7f8b1e30264ee36c22f15f9c`
...
- Final source/test/release-trigger candidate: `6b1544b3a91ecfef2937a909f58a7e9faee31cff`.
- Release-readiness run **31878003640** completed successfully for `core-and-tests`, Android compile/audit, Windows compile/audit, Apple Mac Catalyst + iOS Share Extension + iOS containing-app compile/audits, and the final aggregate `release-gate`.
- Release evidence digests recorded by GitHub Actions:
  - `dependency-audit`: `sha256:f409ded988ab83a844879cdc508c9bb1eebba03bdf3b84f936790a88b0582f34`
  - `android-dependency-audit`: `sha256:d4041649f7d12205c8efe8ba89f68849729287e990094251bdb915d8b495511b`
  - `windows-dependency-audit`: `sha256:77d8bbe5c9b6003c9167217dc454b034e27df89f41889dbfaad283e295c26a86`
  - `apple-dependency-audit`: `sha256:4eb6679649fb4e3224ee024e02294a09c65c1cbe6fe062c0d9bd9fa87d277713`
...
- The final runtime source boundary is `406c2cfb48c45e04cc34662776e67a68f167745d`; test/release-trigger contract boundary is `6b1544b3a91ecfef2937a909f58a7e9faee31cff`. Subsequent documentation/ledger/helper-cleanup commits do not alter runtime source.
